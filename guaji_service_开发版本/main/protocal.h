...
#define		S_SERVER_NOTI_MID				0x0006		//腾讯MID通知到服务器
...
#define		S_SYSTEM_BROADCAST				0x000F		//广播用
...
#define		S_REQUEST_INGOT_INFO			0x0014      //首充列表
...
#define		S_PRECIOUS_TRAIN_INFO			0x004C		// 请求神器培养
#define		S_PRECIOUS_FORGE				0x004D		// 神器锻造
#define		S_PRECIOUS_UP_STAR				0x004E		//神器升星
#define		S_PRECIOUS_TRANSLATE			0x004F		//神器传承
...
#define		S_QUICK_FIGHT_BOSS				0x0064		//快速挑战boss
...
#define		S_FIGHT_TIP						0x0082		// 服务器通知上次离线战斗类型

// 系统
#define		S_SYSTEM_INFO				0x0090		// 系统信息
#define		S_ACTIVITY_INFO				0x0091		// 活动信息
...
#define		S_GUILD_GET_CONTRIBUTE			0x0419		//获取捐献信息
#define		S_GUILD_CONTRIBUTE				0x0420		//捐献金币
#define		S_GUILD_SET_CONDITION			0x0421		//会长设置入会条件
#define		S_GUILD_SIGNIN					0x0422		//签到
#define		S_GUILD_SIGEXCHANGE				0x0423		//捐献兑换道具
#define		S_GUILD_WORSHIPINFO				0x0424		//门派圣地膜拜
#define		S_GUILD_WORSHIP					0x0425		//门派模拜
...
#define		S_GET_LEVEL_PRISE_DATA			0x0807		// 冲级新人王
#define		S_REQUEST_FUND_STATE			0X0808		// 请求基金状态
#define		S_REQUEST_TO_BUY_FUND			0x0809		// 请求购买开服基金
#define		S_REQUEST_FUND_GETFUND			0x0810		// 请求领取开服基金
#define		S_REQUEST_TAO_DRAW				0x0811		// 请求淘
#define		S_REQUEST_TAO_RESULT			0x0814		// 请求淘

// 宝藏
#define		S_REQUEST_BAO_INFO				0x0815  //三条数据 点击，伤害
#define		S_REQUEST_BAO_RANK				0x0816  //排行的数据
#define		S_REQUEST_BAO_RESULT			0x0817  //战斗结果  获得超出的百分比
#define		S_REQUEST_BAO_COST				0x0818	// 消耗元宝

#define		S_REQUEST_TAO_ITEM				0x0812		// 请求领取奖励
#define		S_REQUEST_TAO_LEFTTIME			0x0813		// 请求剩余淘次数

// 镖局
#define		S_BODYGUARD_START			0x0820	//镖局 开始
#define		S_BODYGUARD_STATUS		0x0821	//镖局 状态
#define		S_BODYGUARD_GET_REWARD		0x0822	//镖局 领奖励
#define		S_BODYGUARD_DIVINATION		0x0823	//镖局 卜一卦
#define		S_BODYGUARD_LOOT_PRE			0x0825	//镖局 准备打劫
#define		S_BODYGUARD_BUY_LOOT_COUNT	0x0826	//镖局 购买打劫次数
#define		S_BODYGUARD_LIST			0x0827	//镖局 可打劫列表
#define		S_BODYGUARD_BEEN_LOOT_RECORD	0x0828	//镖局 被打劫记录
...
#define		NOTI_MATE_KICKED_OFF			0x083F		//队员被踢出
...
namespace PROTOCAL
{
	...
	int set_phone_imei(ROLE* role, unsigned char * data, size_t dataLen);
	int chargeRole( DWORD dwChargeNum, ROLE* role, bool bGm  );
	...
	void saveAllToDb(bool bForce = false );
